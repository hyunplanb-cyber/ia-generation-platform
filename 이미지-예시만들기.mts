 ...
 *   판매용_템플릿/_이미지/마스코트/장면/*.png           ← 우리가 만든 고양이 (배경 있는 것)
...
/* ⚠ 2026-08-13 에 그림을 «_이미지» 한 곳으로 모았다.
   ...
   마스코트는 우리가 만든 것이라 「받은 사진」이 아니다. 그래서 자리가 따로다 —
   `마스코트` 라고 부르면 _이미지/마스코트/장면 을 원본으로 본다. */
const 원본방 = "판매용_템플릿/_이미지/사진";
const 낼방뿌리 = "판매용_템플릿/_이미지/팩용";
const 마스코트원본 = "판매용_템플릿/_이미지/마스코트/장면";
const 원본어디 = (업종: string) => (업종 === "마스코트" ? 마스코트원본 : join(원본방, 업종));
