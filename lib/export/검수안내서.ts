...
/** 재는 열두 가지 — 홍보에도 그대로 쓴다. 한 곳에만 적는다.
 *
 * ⛔ 2026-09-08 에 둘을 더했다. 사장님이 우리 스펙팩으로 사이트를 지어 보시고
 *   「콘텐츠 영역 엉망, 그리드 하나도 안 맞는 박스들하며」라고 하셨는데,
 *   이 목록의 열 가지로는 **둘 다 못 잡았다.** 재 보니 —
 *     · 콘텐츠 폭은 «재기만 하고 견주지 않았다» — 숫자만 내보내고 아무것도 불합격 안 시켰다
 *     · 「나란한 사진 크기」는 img 태그만 찾았는데, 스펙팩으로 지은 사이트에는
 *       img 가 0개고 자리표시자가 121개였다. 찾을 것이 없으니 늘 통과였다
 *   손님이 이 안내서대로 검수해도 못 찾는다면, 검수를 안 한 것과 같다. */
export const 재는것들: { 무엇: string; 어떻게: string }[] = [
  ...
  { 무엇: "나란한 사진 크기가 같은가", 어떻게: "윗변이 같은 것끼리만 높이를 견줍니다. 사진이 아직 안 들어간 «자리표시자»도 셉니다" },
  { 무엇: "한 화면 안에서 콘텐츠 폭이 갈리나", 어떻게: "본문 덩어리들의 왼쪽 끝이 몇 번 움직이는지 셉니다. 셋부터 짚습니다" },
  { 무엇: "나란히 선 칸들의 제목 높이가 맞나", 어떻게: "한 줄에 선 것끼리만 견줍니다 — 한 칸에만 배지가 붙으면 그 칸만 밀립니다" },
...
<body><div class="wrap">
  ...
  <div class="card">
    <h2 style="font-size:19px;font-weight:800;margin-bottom:12px">무엇을 재나 — 열두 가지</h2>
