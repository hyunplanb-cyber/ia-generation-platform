...
/** "만들고 끝내지 말고 눌러 보라"는 안내 — 화면목록·검수시나리오·README가 같은 말을 쓴다.
 *
 * 우리가 만든 스펙팩으로 우리가 화면을 만들었는데도 매번 고칠 것이 나왔다.
 * 스펙이 부실해서가 아니라 AI가 스펙을 읽고 옮기는 과정에서 어긋나기 때문이다.
 * 그걸 숨기면 사는 사람이 안 눌러 보고, 이상한 채로 오픈한다. 그래서 적어 둔다. */
export const AI_CHECK_NOTE: string[] = [
  "AI는 실수합니다. 스펙을 잘 써 두어도 만들어진 화면이 의도와 다를 수 있습니다.",
  "이 스펙팩을 만든 저희도, 같은 설계로 화면을 만들 때마다 고칠 것이 나왔습니다.",
  "",
  "실제로 나왔던 것들입니다 —",
  ...
  "",
  "만들고 끝내지 마세요. 화면을 하나씩 열어 눌러 보며 확인해 주세요.",
...
export function buildTemplateVerifySheets(
  ...
  const cover: (string | number)[][] = [
    ...
    [],
    // 만든 사람이 겪은 걸 그대로 적는다. "잘 만들었으니 그냥 쓰세요"라고 하면
    // 사는 사람이 안 눌러 보고, 나중에 화면이 이상한 걸 뒤늦게 발견한다.
    ["", "먼저 읽어 주세요", "AI는 실수합니다. 스펙을 잘 써 두어도 만들어진 화면이 의도와 다를 수 있습니다."],
    ["", "", "이 스펙팩을 만든 저희도, 같은 설계로 화면을 만들 때마다 고칠 것이 나왔습니다."],
    ["", "", "실제로 나왔던 것들입니다 —"],
    ["", "", "· 뒤로가기가 화면에 안 붙는다 (2뎁스 이상 125개 중 125개 전부 빠진 적이 있습니다)"],
    ["", "", "· 정의하지 않은 CSS 값을 써서 간격이 조용히 0이 된다"],
    ...
    ["", "", "· 화면 안에서 끝나야 할 조작이 '준비 중입니다' 안내로 때워진다"],
    [],
    ["", "", "그래서 이 점검표가 있습니다. 만들고 끝내지 마시고,"],
    ["", "", "화면을 하나씩 열어 눌러 보며 확인해 주세요."],
    ["", "", "빠르게 훑으면 30분, 꼼꼼히 보면 두세 시간 걸립니다. 오픈 전에 꼭 한 번 하세요."],
    [],
