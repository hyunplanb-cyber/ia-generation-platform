...
export function buildSpecPackMarkdown(
  ...
  lines.push(
    "- **글꼴은 프리셋이 없어도 한 벌로 고정하세요.** 한글은 `Pretendard`(없으면 `Noto Sans KR`) 하나면 충분합니다. "
    + "굵기는 **400·600·700 셋만** 쓰고, 크기는 본문 15 · 카드 제목 18 · 섹션 제목 22 · 페이지 제목 32을 기준으로 잡으세요. "
    + "제목마다 다른 글꼴을 섞으면 화면이 산만해집니다.",
  );
