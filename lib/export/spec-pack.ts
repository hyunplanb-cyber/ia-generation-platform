...
export function buildSpecPackMarkdown(
  ...
  lines.push("");
  lines.push("### 7-2. 뒤로가기는 4장에 적힌 그 화면으로 갑니다");
  ...
  lines.push("");
  lines.push("### 7-3. 화면 목록과 실제가 같은지 셉니다");
  ...
  lines.push("");
  lines.push("### 7-4. 폰 폭에서 다시 한 번");
  lines.push("- 위 「좁은 화면에서 넘치지 않게」를 **다 만든 뒤에 다시** 확인합니다. 화면이 늘어나면서 새로 넘치는 곳이 생깁니다.");
  lines.push("");
  lines.push("### 7-5. 무엇을 확인했는지 적어 주세요");
  lines.push("- 위 네 가지를 **숫자로** 적어 남깁니다 — 「빈 링크 0개 · 반응 없는 단추 0개 · 뒤로가기 어긋남 0개 · 가로 넘침 0개」.");
