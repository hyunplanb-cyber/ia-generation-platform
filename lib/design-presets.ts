...
export const COMMON_RULES: string[] = [
  ...
  "```",
  "",
  "**⑫ 목록 카드가 «저마다 제 상세»로 가게 하세요.**",
  "강의·고수·상품처럼 목록에 늘어놓은 카드가 **전부 같은 상세로 가면**",
  "눌러 본 사람은 바로 «가짜»로 읽습니다. 우리 팩에서도 한 목록의 카드 열두 개가 다 같은 곳으로 갔습니다.",
  "- 카드마다 **다른 화면**으로 잇는 것이 첫째입니다.",
  "- 견본이라 한 곳으로 보낼 수밖에 없으면 **그 말을 화면에 적으세요** —",
  "  「견본이라 어느 카드를 눌러도 같은 상세가 열립니다」 한 줄이면 어긋남이 사라집니다.",
