    ...
    <div className="cc">
      ...
      <style jsx>{`
        ...
        .hero-photo {
          ...
          border-radius: 6px;
          border: 1px solid var(--paper-line);
          background: radial-gradient(120% 80% at 30% 20%, #2f7d6a 0%, #1c5d52 40%, #123f39 100%);
          position: relative;
          overflow: hidden;
          display: flex;
        ...
        .hero-photo .beach {
          ...
          bottom: 0;
          height: 44%;
          background: linear-gradient(180deg, #6cc3b0 0%, #e9d9b0 55%, #d9c39a 100%);
        }
        .hero-photo .kc {
          position: relative;
          z-index: 2;
