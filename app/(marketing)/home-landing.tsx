    ...
    <div className="cc" ref={뿌리}>
      ...
      <style jsx>{`
        .cc {
          ...
          /* 단추 «바탕»은 따로 둔다. --o 는 글자색으로도 쓰여서, 어두운 칸에서
             글자를 밝히면 단추 바탕까지 밝아져 흰 글자가 안 읽힌다(2026-09-02). */
          --o-btn: #b23b1a; /* 흰 글자 5.94 */
          --t1: #5c5545;
        ...
        .dark {
          ...
          /* ⛔ 어두운 바탕은 «반대»다 (2026-09-02).
             밝은 바탕에서 읽히라고 색을 진하게 내렸더니 이 칸에서는 되레
             안 보이게 됐다 — 진한 글자가 어두운 바탕에 묻힌다.
             검수항목 H9 가 「어두운 바탕은 반대다」라고 적어 둔 바로 그 자리다.
             그래서 이 칸 안에서만 «올려» 둔다. 이름이 같으니 안쪽 규칙은
             한 줄도 안 고쳐도 된다. */
          --t3: #8d8167; /* 이 바탕(#191713) 위 4.66 */
          --t4: #958d7f; /* 4.60~5.45 — 안쪽 옅은 칸(#282622·#262420)까지 넘는다 */
          --o: #e36340; /* 4.52~5.22 */
          /* ⚠ --o-btn 은 «안» 올린다. 단추 바탕이 밝아지면 그 위 흰 글자가
             3.43 으로 떨어진다 — 실제로 그렇게 됐다. 바탕은 어두운 채로 둔다. */
        }
        .dk-top {
          display: grid;
