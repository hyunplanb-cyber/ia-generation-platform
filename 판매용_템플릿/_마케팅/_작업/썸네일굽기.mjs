...
const 목록 = [
  ...
  /* 6주 금 9/19 — 갈래 ⑦. 새로 들어온 중고거래 팩. «버튼을 누르면 어디로» 가 이 편의 주장이다 */
  { 파일: "썸네일_영상23_단추누르면어디로_16_9", sheet: "중고거래 디럭스 팩", rows: "화면,40개,ok|채팅 다음 화면,다 나옴,ok|버튼 → 이동화면,101줄,ok", v: 16, pose: "커피_없어", pos: "tr",
    big: "채팅만 되면|될 줄 알았는데|<span class='o'>정산까지</span>|다 나왔어요", sub: "", ep: "중고거래 사이트 편" },
  ...
  /* 9주차 (2026-09-11) — 세 편. 터미널 편은 재료가 못 받쳐 접었다.
     자리는 셋 다 tr 이다. 아래 주석대로 목록 칸이 있으면 tr 말고는 성한 자리가 없다. */
  { 파일: "썸네일_영상30_다됐다는말믿지않기_16_9", sheet: "온라인 강의 팩", rows: "전체 화면,132개,ok|눌렀을 때 동작,116개,ok|뒤로가기 붙은 화면,121개,ok", v: 16, pose: "아이디어", pos: "tr",
    big: "<span class='o'>다 됐다</span>는 말|하나씩|눌러 봤어요", sub: "", ep: "검수 편" },

  { 파일: "썸네일_영상31_고수화면이없었다_16_9", sheet: "한 줄로 시켰을 때", rows: "한 줄 프롬프트 고수 메뉴,5개,no|AI팩 고수 화면,12개,ok|AI팩 전체 화면,43개,ok", v: 16, pose: "깜짝", pos: "tr",
    big: "한 줄로 시켰더니|<span class='o'>고수 화면</span>이|없었어요", sub: "", ep: "매칭 사이트 편" },

  { 파일: "썸네일_영상32_기능하나더_16_9", sheet: "인테리어 프리미엄 팩", rows: "화면,207개,ok|기준 화면,40개,ok|세부 상태,167개,ok", v: 16, pose: "대표_코딩", pos: "tr",
    big: "기능 하나 더|<span class='o'>스펙팩</span>|어디를 고치나요", sub: "", ep: "인테리어 시공 편" },
];
