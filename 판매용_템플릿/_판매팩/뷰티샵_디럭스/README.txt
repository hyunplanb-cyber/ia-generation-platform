...
■ 구성
 ...
 02_IA_화면목록.xlsx     화면 49개 + 화면별 AI 생성 프롬프트  ★핵심
 03_기능정의서.xlsx      요건 349개 (업무·기능·구성·유형)
...
■ 완성화면 — 만들어진 결과부터 보세요
 ...
 완성화면/index.html 을 브라우저로 열면 화면 49개가 목록으로 나옵니다.
 ...
 화면 49개가 한 번에 다시 만들어집니다. (Node.js 필요)
