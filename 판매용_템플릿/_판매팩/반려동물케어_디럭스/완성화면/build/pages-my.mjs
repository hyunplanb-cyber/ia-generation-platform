...
/** 등원 → 하원 사이를 «빼서» 적는다.
    ⛔ 손으로 적어 두면 시각을 고쳐도 이 줄만 안 따라온다 — 실제로 09:02→18:05 를
       「8시간 3분」이라 적어 두고 있었다(2026-08-31에 잡음). */
function 머문시간(들어옴, 나감) {
...
export const PAGES = {
  /* ============================================================
     ...
     ============================================================ */
  'MY-01': () => {
    /* ⚠ 날짜순으로 세운다. 손으로 적은 차례는 반드시 한 번 어긋난다 — 실제로
       8/26 → 8/28 → 8/27 → 8/31 로 적혀 있었다. 아래 sort 가 그것을 막는다. */
    const 예정 = [
...
${card('', `
  <div class="row wrap-row">
    ...
    <div class="center">
      ...
      <div class="t-sub">재원 ${머문시간(n.inAt, n.outAt)}</div>
    </div>
  </div>`)}
