반려견 유치원 등원 예약·운영 — 프리미엄
AI팩 — 기획 산출물 한 벌 + 완성 화면
====================================================

■ 구성
 01_메뉴구조.xlsx        메뉴-화면 트리
 02_IA_화면목록.xlsx     화면 172개 + 화면별 AI 생성 프롬프트  ★핵심
 03_기능정의서.xlsx      요건 661개 (업무·기능·구성·유형)
 ...
 08_검수시나리오.xlsx     오픈 전 점검표 — 시나리오 172개  ★디럭스·프리미엄
 디자인프리셋/
 ...
 완성화면/               이 스펙팩으로 실제로 만든 화면 172개 (HTML)  ★프리미엄
...
■ 완성화면 — 만들어진 결과부터 보세요
 ...
 완성화면/index.html 을 브라우저로 열면 화면 172개가 목록으로 나옵니다.
 ...
 화면 172개가 한 번에 다시 만들어집니다. (Node.js 필요)
...
■ 어디까지 만들어지나요 — 먼저 읽어주세요
 ...
 이 서비스에서 개발자에게 넘길 항목 5가지
  · 로그인·회원가입 — 이메일 가입, 소셜 로그인, 보호자·원 운영진 두 권한 구분
  · 결제·자동청구 — 회차권·1회권 결제와 정기 요일권 매월 자동 청구
  · 사진·문서 업로드 — 반려견 사진, 백신 접종증명서, 알림장 사진, 사고 기록 사진
  · 알림 — 등원·하원 확인, 알림장 발송, 백신 만료, 반 변경, 사고 발생 알림
  · 실시간 인원 집계 — 반별 정원 대비 현재 인원, 등하원 체크와 회차권 차감 연동
