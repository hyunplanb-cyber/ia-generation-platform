...
${card('복용 중인 약', `
  ...
  <div id="medBox" class="mt6" hidden>
    <div class="f2">
      ...
      ${field('급여 시간', select(['점심(12:30)', '오후(14:00)', '간식 시간(15:30)', '직접 적기'], 1, { attr: ' data-reveal-when="직접 적기" data-reveal-box="fdTime"' }))}
    </div>
    ${field('시간 직접 적기', input({ ph: '예: 오전 10:30' }), { id: 'fdTime', hide: true })}
