...
export function VC0101(ctx) {
  ...
  <div class="split">${myNav('VC0101')}<div>
    ...
    cls: 'mb4',
    right: `<div class="btns"><button class="btn btn-primary btn-sm" type="button" ${saved ? '' : `onclick="location.href='${link('VC0103')}'"`}>이미지로 저장</button>
...
export function VC0201(ctx) {
  ...
  <div class="btns" style="justify-content:center">
    <button class="btn btn-primary btn-lg" type="button" ${offline ? '' : `onclick="location.href='${link('VC0103')}'"`}>이미지로 저장</button>
