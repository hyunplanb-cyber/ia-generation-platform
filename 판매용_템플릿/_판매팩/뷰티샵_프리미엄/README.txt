...
■ 구성
 ...
 02_IA_화면목록.xlsx     화면 136개 + 화면별 AI 생성 프롬프트  ★핵심
 03_기능정의서.xlsx      요건 774개 (업무·기능·구성·유형)
 ...
 08_검수시나리오.xlsx     오픈 전 점검표 — 시나리오 136개  ★디럭스·프리미엄
 디자인프리셋/
 ...
 완성화면/               이 스펙팩으로 실제로 만든 화면 136개 (HTML)  ★프리미엄
...
■ 완성화면 — 만들어진 결과부터 보세요
 ...
 완성화면/index.html 을 브라우저로 열면 화면 136개가 목록으로 나옵니다.
 ...
 화면 136개가 한 번에 다시 만들어집니다. (Node.js 필요)
...
■ 어디까지 만들어지나요 — 먼저 읽어주세요
 ...
 이 서비스에서 개발자에게 넘길 항목 6가지
  · 로그인·회원가입 — 이메일 가입, 카카오 등 소셜 로그인, 휴대폰 본인인증
  · 예약금·결제 — 카드·간편결제(PG), 취소 수수료와 환불
  · 지도·위치 — 매장 찾기, 내 주변 검색, 길찾기 연결
  · 예약 알림 — 확정·리마인더·노쇼 안내 알림톡/문자 발송
  · 사진 업로드 — 시술 사진과 리뷰 이미지 저장
  · 예약 충돌 처리 — 같은 시간대 동시 예약을 막는 서버 처리
