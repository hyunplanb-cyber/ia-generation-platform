...
■ 구성
 ...
 02_IA_화면목록.xlsx     화면 125개 + 화면별 AI 생성 프롬프트  ★핵심
 03_기능정의서.xlsx      요건 731개 (업무·기능·구성·유형)
 ...
 08_검수시나리오.xlsx     오픈 전 점검표 — 시나리오 125개  ★디럭스·프리미엄
 디자인프리셋/
 ...
 완성화면/               이 스펙팩으로 실제로 만든 화면 125개 (HTML)  ★프리미엄
...
■ 완성화면 — 만들어진 결과부터 보세요
 ...
 완성화면/index.html 을 브라우저로 열면 화면 125개가 목록으로 나옵니다.
 ...
 화면 125개가 한 번에 다시 만들어집니다. (Node.js 필요)
...
■ 어디까지 만들어지나요 — 먼저 읽어주세요
 ...
 이 서비스에서 개발자에게 넘길 항목 6가지
  · 로그인·회원가입 — 이메일 가입, 카카오·네이버 소셜 로그인
  · 조건부 결제 — 성사 전 결제 보류, 미달 시 전액 자동 환불
  · 재고·수량 — 동시 참여로 목표 수량을 넘지 않게 막는 서버 처리
  · 배송 — 송장 등록과 배송 조회 연동
  · 알림 — 달성 임박·성사·취소 안내 알림톡 발송
  · 진행자 정산 — 성사분 정산액 계산과 계좌 지급
