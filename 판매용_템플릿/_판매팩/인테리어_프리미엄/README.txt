인테리어 시공 견적·시공관리 — 프리미엄
AI팩 — 기획 산출물 한 벌 + 완성 화면
====================================================

■ 구성
 01_메뉴구조.xlsx        메뉴-화면 트리
 02_IA_화면목록.xlsx     화면 207개 + 화면별 AI 생성 프롬프트  ★핵심
 03_기능정의서.xlsx      요건 776개 (업무·기능·구성·유형)
 ...
 08_검수시나리오.xlsx     오픈 전 점검표 — 시나리오 207개  ★디럭스·프리미엄
 디자인프리셋/
 ...
 완성화면/               이 스펙팩으로 실제로 만든 화면 207개 (HTML)  ★프리미엄
...
■ 완성화면 — 만들어진 결과부터 보세요
 ...
 완성화면/index.html 을 브라우저로 열면 화면 207개가 목록으로 나옵니다.
 ...
 화면 207개가 한 번에 다시 만들어집니다. (Node.js 필요)
...
■ 어디까지 만들어지나요 — 먼저 읽어주세요
 ...
 이 서비스에서 개발자에게 넘길 항목 6가지
  · 로그인·회원가입 — 이메일 가입, 소셜 로그인, 손님·업체(현장 관리자) 두 권한 구분
  · 결제·분할 청구 — 계약금·착공금·중도금·잔금 분할 결제, 카드·계좌이체·무통장
  · 전자서명 — 계약서 서명과 준공 검수 확인에 쓰는 서명 캡처·저장
  · 사진·영상 업로드 — 현장 사진 일지, 추가공사 근거 사진, 하자보수 접수 사진 저장
  · 알림 — 실측 예약 확인·공정 진행·추가공사 승인 요청·하자보수 처리 발송
  · 주소·지도 — 시공 현장 주소 검색과 실측·방문 일정 안내
