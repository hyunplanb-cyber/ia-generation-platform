...
■ 구성
 ...
 02_IA_화면목록.xlsx     화면 159개 + 화면별 AI 생성 프롬프트  ★핵심
 03_기능정의서.xlsx      요건 877개 (업무·기능·구성·유형)
 ...
 08_검수시나리오.xlsx     오픈 전 점검표 — 시나리오 159개  ★디럭스·프리미엄
 디자인프리셋/
 ...
 완성화면/               이 스펙팩으로 실제로 만든 화면 159개 (HTML)  ★프리미엄
...
■ 완성화면 — 만들어진 결과부터 보세요
 ...
 완성화면/index.html 을 브라우저로 열면 화면 159개가 목록으로 나옵니다.
 ...
 화면 159개가 한 번에 다시 만들어집니다. (Node.js 필요)
...
■ 어디까지 만들어지나요 — 먼저 읽어주세요
 ...
 이 서비스에서 개발자에게 넘길 항목 6가지
  · 로그인·회원가입 — 이메일 가입, 소셜 로그인, 고수 본인인증
  · 견적 크레딧 — 고수가 견적을 보낼 때 차감하는 크레딧 충전·결제
  · 채팅 — 손님과 고수의 실시간 대화, 사진·파일 주고받기
  · 지도·위치 — 활동 지역 설정과 내 주변 고수 찾기
  · 알림 — 새 요청·견적 도착·선택 결과 발송
  · 고수 정산 — 완료 건 정산액 계산과 계좌 지급
