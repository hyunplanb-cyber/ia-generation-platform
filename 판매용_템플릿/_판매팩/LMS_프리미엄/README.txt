...
■ 구성
 ...
 02_IA_화면목록.xlsx     화면 132개 + 화면별 AI 생성 프롬프트  ★핵심
 03_기능정의서.xlsx      요건 721개 (업무·기능·구성·유형)
 ...
 08_검수시나리오.xlsx     오픈 전 점검표 — 시나리오 132개  ★디럭스·프리미엄
 디자인프리셋/
 ...
 완성화면/               이 스펙팩으로 실제로 만든 화면 132개 (HTML)  ★프리미엄
...
■ 완성화면 — 만들어진 결과부터 보세요
 ...
 완성화면/index.html 을 브라우저로 열면 화면 132개가 목록으로 나옵니다.
 ...
 화면 132개가 한 번에 다시 만들어집니다. (Node.js 필요)
...
■ 어디까지 만들어지나요 — 먼저 읽어주세요
 ...
 이 서비스에서 개발자에게 넘길 항목 6가지
  · 로그인·회원가입 — 이메일 가입, 카카오·구글 등 소셜 로그인
  · 수강 결제 — 카드·간편결제(PG), 환불과 부분 취소
  · 강의 영상 — 영상 업로드·인코딩·스트리밍, 이어보기 시점 저장
  · 과제 파일 — 제출 파일 업로드와 보관
  · 알림 — 과제 마감·수강 안내 이메일/알림톡 발송
  · 강사 정산 — 정산액 계산과 계좌 지급
