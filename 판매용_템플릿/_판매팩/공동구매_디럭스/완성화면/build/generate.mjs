...
const PRESET = path.resolve(ROOT, '스펙팩/가이드_03_코럴선셋.json');
const OUT = path.resolve(ROOT, 'pages');

const BUILDERS = { ...HODE, ...JOMY, ...RVAC, ...HS, ...HM, ...SECS };
...
const 참여자홈 = firstOf('HO') ?? spec.screens[0].pageId;
const 진행자홈 = firstOf('HM') ?? 참여자홈;
...
<header class="gnb"><div class="gnb-in">
  ...
  <nav class="gnb-nav"><a href="pages/${참여자홈}.html">참여자 홈</a><a href="pages/${진행자홈}.html">진행자 화면</a></nav>
</div></header>

<section class="idx-hero"><div class="wrap">
  <h1 class="t-page" style="color:#fff">공동구매(공구) 플랫폼 — 전체 화면</h1>
