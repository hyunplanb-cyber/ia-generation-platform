해외 투어·티켓 예약 플랫폼 — 프리미엄
AI팩 — 기획 산출물 한 벌 + 완성 화면
====================================================

■ 구성
 01_메뉴구조.xlsx        메뉴-화면 트리
 02_IA_화면목록.xlsx     화면 144개 + 화면별 AI 생성 프롬프트  ★핵심
 03_기능정의서.xlsx      요건 799개 (업무·기능·구성·유형)
 ...
 08_검수시나리오.xlsx     오픈 전 점검표 — 시나리오 144개  ★디럭스·프리미엄
 디자인프리셋/
 ...
 완성화면/               이 스펙팩으로 실제로 만든 화면 144개 (HTML)  ★프리미엄
...
■ 완성화면 — 만들어진 결과부터 보세요
 ...
 완성화면/index.html 을 브라우저로 열면 화면 144개가 목록으로 나옵니다.
 ...
 화면 144개가 한 번에 다시 만들어집니다. (Node.js 필요)
...
■ 어디까지 만들어지나요 — 먼저 읽어주세요
 ...
 이 서비스에서 개발자에게 넘길 항목 6가지
  · 로그인·회원가입 — 이메일 가입, 소셜 로그인, 비회원 예약 조회
  · 예약 결제 — 카드·간편결제(PG), 해외 결제와 환율, 부분 취소 환불
  · 지도·위치 — 집합 장소 안내, 길찾기, 픽업 구역 조회
  · 바우처 — QR 코드 발급과 현장 검증, 오프라인 보기
  · 알림 — 예약 확정·출발 임박·기상 취소 안내 발송
  · 다국어·통화 — 현지어 표기와 통화 변환
