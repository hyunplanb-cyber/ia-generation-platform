회원끼리 사고파는 중고거래 장터 — 프리미엄
AI팩 — 기획 산출물 한 벌
====================================================

■ 구성
 01_메뉴구조.xlsx        메뉴-화면 트리
 02_IA_화면목록.xlsx     화면 201개 + 화면별 AI 생성 프롬프트  ★핵심
 03_기능정의서.xlsx      요건 978개 (업무·기능·구성·유형)
 ...
 08_검수시나리오.xlsx     오픈 전 점검표 — 시나리오 201개  ★디럭스·프리미엄
 디자인프리셋/
...
■ 어디까지 만들어지나요 — 먼저 읽어주세요
 ...
 이 서비스에서 개발자에게 넘길 항목 7가지
  · 로그인·회원가입 — 이메일 가입, 소셜 로그인, 본인인증. 회원 한 사람이 사는 쪽이자 파는 쪽이다
  · 위치·동네 인증 — 현재 위치로 동네 잡기, 동네 인증, 거리순 정렬과 동네 범위 3단계
  · 사진 업로드 — 판매글 사진 최대 10장, 순서 바꾸기와 대표 지정, 채팅 사진, 신고 증거 캡처
  · 1:1 채팅 — 실시간 대화, 읽음 표시, 가격 제안 카드와 약속 카드, 차단·신고
  · 안전결제(에스크로) — 결제 대금 보관, 운송장 등록, 구매확정 시 정산, 자동 확정 기한, 분쟁 시 보류
  · 알림 — 관심 키워드 새 매물, 찜한 물건 값 내림, 채팅, 거래 상태 바뀜, 후기 도착
  · 결제(끌올·광고) — 끌올·상단 고정 상품 결제와 포인트, 집행 내역과 환불
