...
const TEMPLATES = {
  lms: { data: LMS, out: "_작업/LMS_온라인강의플랫폼", title: "온라인 강의 플랫폼(LMS)" },
  beauty: { data: BEAUTY, out: "_작업/뷰티샵_예약플랫폼", title: "뷰티샵 예약 플랫폼" },
  ...
  ticket: { data: TICKET, out: "_작업/공연티켓_파트너관리자", title: "공연 티켓 파트너 관리자" },
